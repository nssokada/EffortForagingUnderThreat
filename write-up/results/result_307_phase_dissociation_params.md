...
The H8 result ([[result_402]]) addresses the analogous question (cross-channel ω → vigor) in the current framework, and the result there is stronger and cleaner. Result 307 should be treated as a documentation of the deprecated approach, with the H8 framework being the live test.

## References

- `instructions/memory/hypotheses.md` § H7, § H14 ("two-system architecture, reframed").
- [[result_402]] — Cross-channel ω → vigor (M4-era analog).
