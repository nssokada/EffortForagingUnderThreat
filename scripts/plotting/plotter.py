...
def _polish_parameter_axes(
    ...
    show_horizontal_lines=False, manage_layout=True
):
...
def plot_parameter_half_violin_glow(
    ...
    gradient_alpha_top=0.30, show_baseline_lines=False, ax=None
):
    """
    ...
    _polish_parameter_axes(ax, y_positions,
                           show_horizontal_lines=show_baseline_lines,
                           manage_layout=_own_fig)
